...
VALUES (1, 'super_admin', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '男', 20, '超级管理员',
       ...
       (2, 'data_admin', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '男', 20, '数据管理员',
        ...
        '2022-07-08 11:30:44'),
       (3, 'update_admin', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '男', 20, '修改管理员',
        ...
        '2022-07-08 11:30:44'),
       (4, 'insert_admin', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '男', 20, '添加管理员',
       ...
       (5, 'delete_admin', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '男', 20, '删除管理员',
       ...
       (6, 'auth_user', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '男', 20, '权限管理员',
        'https://img2.baidu.com/it/u=4244269751,4000533845&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', '13900139005',
        'fanchuanqi@baidu.com', '范传奇老师的账号', 1, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (7, 'user', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '男', 20, '普通用户',
        'https://img2.baidu.com/it/u=4244269751,4000533845&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', '13900139005',
        'fanchuanqi@baidu.com', '范传奇老师的账号', 1, '2022-07-08 11:30:44', '2022-07-08 11:30:44');
...
VALUES (1, 1, 1, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ...
       (7, 7, 7, '2022-07-08 11:30:44', '2022-07-08 11:30:44');
...
VALUES (1, '读取用户', '/user/read', '读取用户信息', 255, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (2, '添加用户', '/user/insert', '添加用户', 254, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (3, '删除用户', '/user/delete', '删除用户', 253, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (4, '修改用户', '/user/update', '修改用户信息，含修改密码、启用、禁用、修改基本资料，及其它修改操作', 252, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (5, '创建空间', '/space/create', '添加文件存储空间', 99, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (6, '删除空间', '/space/delete', '删除文件存储空间', 98, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (7, '读取空间', '/space/list', '查询用户存储空间的列表', 97, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (8, '空间权限', '/space/updateToAuth', '修改存储空间的访问权限(公开/私有)', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (9, '设置标签', '/space/AddTags', '设置存储空间的标签', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (10, '删除标签', '/space/delTags', '删除存储空间的标签', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (11, '上传文件', '/file/upload', '上传文件，含图片，txt文件等', 96, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (12, '复制文件', '/file/copy', '复制文件', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (13, '删除文件', '/file/delete', '删除文件', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (14, '修改存储状态', '/file/updateSpaceStatus', '修改文件的存储状态(启用/禁用)', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (15, '修改存储类型', '/file/updateSpaceType', '修改文件的存储类型', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (16, '修改过期时间', '/file/updateDelTime', '修改文件的过期删除时间', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (17, '分配权限', '/auth/assign', '分配角色和权限', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44');
...
VALUES (1, '超级管理员', '最高权限的管理员角色，应该关联所有权限', 255, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ...
       (6, '权限管理员', '负责分配权限的相关功能', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (7, '普通用户', '创建存储空间、文件上传、文件资源复制', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44');
...
VALUES (1, 1, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ...
       (1, 17, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ...
       (6, 1, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (6, 17, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (7, 5, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (7, 11, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (7, 12, '2022-07-08 11:30:44', '2022-07-08 11:30:44');
